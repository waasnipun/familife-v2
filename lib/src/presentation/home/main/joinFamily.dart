...
class JoinAnotherFamilyPage extends StatefulWidget {
  @override
  _JoinAnotherFamilyPageState createState() => _JoinAnotherFamilyPageState();
}

class _JoinAnotherFamilyPageState extends State<JoinAnotherFamilyPage> {
  late double width, height;

  TextEditingController nameController = new TextEditingController();
  var authProvider, dbProvider;
  bool loading = false;
                    ...
                    child: FlatButton(
                      ...
                      onPressed: () async {
                        ...
                        if (nameController.text.length == 0) {
                          ...
                          var result =
                              await dbProvider.checkNewFamilyCodeValidity();
                          if (result) {
                            result = await dbProvider.joinFamily();
                            if (result) {
                              Navigator.of(context)
                                  .pushReplacement(pageRouteNormal(MainPage(0)));
                            } else {
                      ...
                      Padding(
                        ...
                        child: Container(
                          ...
                          child: TextField(
                            ...
                            onChanged: (value) {
                              dbProvider.setNewFamilyCode = value;
                            },
                          ),
                        ),
                      ),
